...
<h1 className='text-white text-[30px] font-semibold mb-[30px]'>Sign In to <span className='text-cyan-400'>Virtual Assistant</span></h1>
...
<p className='text-[white] text-[18px] cursor-pointer' onClick={()=>navigate("/signup")}>Want to create a new account ? <span className='text-cyan-400'>Sign Up</span></p>
 </form>
    </div>
  )
}
