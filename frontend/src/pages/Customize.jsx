...
function Customize() {
  ...
  return (
    <div className='w-full h-[100vh] bg-gradient-to-t from-[black] to-[#030353] flex justify-center items-center flex-col p-[20px] '>
      ...
      {selectedImage && <button className='px-8 py-3 mt-[30px] text-black font-semibold bg-white rounded-full text-[18px] shadow hover:bg-gray-100 active:scale-95 transition ' onClick={() => navigate("/customize2")}>Next</button>}
